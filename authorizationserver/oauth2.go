...
var (
	...
	store = NewMemoryStoreWithClients()
...
var oauth2 = ComposeAllEnabled(config, store, privateKey)
...
func NewMemoryStoreWithClients() *storage.MemoryStore {
	return &storage.MemoryStore{
		...
		Clients: map[string]fosite.Client{
			"my-client": &fosite.DefaultClient{
				...
				RedirectURIs:   []string{"https://cert.mycredential.eu/callback"},
